...
```{r map-function, message = FALSE}
map.function <- function(polygons,title,style,palette)
  tm_function <- tm_shape(acs_covid) +
    tm_polygons(polygons,
    title = title,
    style = style,
    border.alpha = .2,
    lwd = 0.2,
...
map.function("covid rate","COVID-19 Cases per 100,000 people\n(22 January 2020 to 1 August 2020)", "Jenks", "Oranges")
```
